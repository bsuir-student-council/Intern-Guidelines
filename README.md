...
- [Общее руководство](./general-guide.md)
  - [Феномен «Догвилль» и защита личных границ на работе](./general-guide.md#феномен-догвилль-и-защита-личных-границ-на-работе)
  - [Правила обработки персональных данных при создании опросов](./general-guide.md#правила-обработки-персональных-данных)
